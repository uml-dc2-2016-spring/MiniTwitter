<?php
    ...
    $link = mysqli_connect("localhost", "cl54-twitter", "Ncm!GqsYy", "cl54-twitter");
    ...
    function displayTweets($type) {
        ...
        $query = "SELECT * FROM tweets ".$whereClause." ORDER BY `datetime` DESC LIMIT 15";
        ...
        if ($_SESSION['id'] > 0) {
        	...
        	echo '<div id="tweetSuccess" class="alert alert-success">Your tweet was posted successfully.</div>
    			  ...
    			  <textarea class="form-control" id="tweetContent"></textarea>
  				  </div> <button id="postTweetButton" class="btn btn-primary">Post Tweet</button> </div>';
